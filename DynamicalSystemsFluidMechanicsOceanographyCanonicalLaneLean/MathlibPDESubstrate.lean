import DynamicalSystemsFluidMechanicsOceanographyCanonicalLaneLean.AnalyticObjects
...
def mathlibPDESubstrate : MathlibPDESubstrate := {
  ...
  carriedBoundary := "Mathlib provides analytic substrate; the theorem-local fluid dynamics closure is carried through admitted analytic certificate fields."
}
